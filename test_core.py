...
def test_normalize_date():
    ...
    for bad_date, jalali in [("2026/06/22", False), ("1405-04-01", True), ("1405/4/1", True)]:
        try:
            ac.normalize_date(bad_date, jalali=jalali)
            assert False, "should have failed: " + bad_date
        except ValueError:
            pass
...
def test_normalize_time_code():
    ...
    for bad_time in ["07:39", "24:00:00", "12:60:00"]:
        try:
